...
public class FooterBehavior extends CoordinatorLayout.Behavior<FooterLayout> {
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent,
                                   FooterLayout child, View dependency) {
    ...
    private void updateTranslationForSnackbar(CoordinatorLayout parent, final FooterLayout footerLayout) {
        ...
        if (footerLayout.isShown()
                && Math.abs(currentTransY - targetTransY) > (footerLayout.getHeight() * 0.667f)) {
