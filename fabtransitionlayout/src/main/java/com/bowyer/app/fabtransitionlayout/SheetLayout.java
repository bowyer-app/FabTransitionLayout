...
public class SheetLayout extends FrameLayout implements View.OnTouchListener {
    ...
    private CardView mFabExpandLayout;
    private RevealLinearLayout mRevealLinearLayout;
    ...
    private void init() {
        ...
        mFabExpandLayout = ((CardView) findViewById(R.id.container));
        mRevealLinearLayout = ((RevealLinearLayout) findViewById(R.id.reveal_linear_layout));
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.SheetLayout,
                0, 0);

        int containerPosition;
        try {
            setColor(a.getColor(R.styleable.SheetLayout_sheet_color,
                    outValue.data));
            animationDuration = a.getInteger(R.styleable.SheetLayout_sheet_anim_duration,
                    DEFAULT_ANIMATION_DURATION);
            containerPosition = a.getInteger(R.styleable.SheetLayout_sheet_container_position,
                    1);
        ...
        mRevealLinearLayout.setLayoutParams(getParams(containerPosition));
    }

    private RelativeLayout.LayoutParams getParams(int containerPosition) {
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mRevealLinearLayout
                .getLayoutParams();
        //set left or right
    ...
    public void setColor(int color) {
        mFabExpandLayout.getChildAt(0).setBackgroundColor(color);
    }
    ...
    private void expandLollipop() {
        ...
        toolbarExpandAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mFakeBg.setOnTouchListener(SheetLayout.this);
